...
${contextMovies.map(movie => `${movie.id} | ${movie.title} | ${movie.genreIds}`).join('\n')}
...
`;
    ...
    recommendedIds = recommendedIds.filter(id => typeof id === 'number' && !isNaN(id));
